...
export async function POST(request: NextRequest) {
  try {
    ...
    const subjectOfferings =
      subjectOfferingsResult.data?.map((offering) => ({
        ...
        offering: result.offering
          ? {
              ...
              subject: result.offering.subject
                ? {
                    subjectCode: result.offering.subject.subject_code,
                    subjectName: result.offering.subject.subject_name,
                  }
                : null,
              branch: result.offering.branch
                ? {
                    branchCode: result.offering.branch.branch_code,
                    branchName: result.offering.branch.branch_name,
                  }
                : null,
            }
          : null,
